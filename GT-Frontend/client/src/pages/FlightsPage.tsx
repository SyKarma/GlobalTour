...
/**
 * Convierte un período del backend a un texto amigable.
 *
 * 2026-09-06 -> 06 de septiembre de 2026
 * 2026-09    -> septiembre de 2026
 */
function formatFallbackPeriod(period?: string) {
  if (!period) {
    return '';
  }
...
/**
 * Define el mensaje que se mostrará cuando el backend
 * no encuentre exactamente la búsqueda solicitada
 * y utilice una alternativa.
 */
function getFallbackMessage(
  ...
  const period = formatFallbackPeriod(
    meta.fallbackPeriod,
  );
    ...
    <main className="flights-page">
      ...
      {isLoading && (
        <section className="flights-status">
          ...
          <p>
            Estamos comparando vuelos disponibles para
            tu viaje.
          </p>
        </section>
      )}
      ...
      {!isLoading &&
        ...
        flights.length === 0 && (
          <section className="flights-status">
            ...
            <p>
              Intenta cambiar las fechas o seleccionar
              otra ruta.
            </p>
          </section>
        )}
          ...
          <>
            <section className="flights-results-heading">
              <div>
                ...
                <p>
                  Filtra y ordena los resultados según
                  tus preferencias.
                </p>
              </div>
