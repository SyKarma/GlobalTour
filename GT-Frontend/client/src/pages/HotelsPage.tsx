  ...
  return (
    <main className="hotels-page">
      <section className="hotels-header">
        ...
        <p>
          Busca y compara alojamientos para tu próximo
          viaje.
        </p>
      </section>
      ...
      {!hasSearch && (
        <section className="hotels-empty-start">
          ...
          <p>
            Selecciona un destino, las fechas de tu
            estadía y la cantidad de huéspedes para
            comenzar.
          </p>
        </section>
      )}
      ...
      {hasSearch &&
        ...
        hotels.length === 0 && (
          <section className="hotels-status">
            ...
            <p>
              Prueba con otro destino o vuelve a
